...
CommandStringsEUEnglish::CommandStringsEUEnglish(){
	...
	rules[STR_SKILL_SUCC_SubTypeExtendDuration_A_TO_B] = "[%SkillTarget]'s %0skill durations changed because [%SkillCaster] used [%SkillName].";
	...
	rules[STR_MSG_INVADE_DIRECT_PORTAL_OPEN_NOTICE] = "<p>The Time-Space Battle has begun.</p><p>If the Power Generator of the Portal Rift is destroyed</p><p>or you leave the battle zone,</p><p>you will be sent back to your zone and logged out of the Alliance.</p><p></p><p>You will also be exclude from the battle if you use a skill or an item to return.</p>";
	...
	rules[STR_POPUP_ADDEXP_USE_ITEM_CONFIRM] = "<p><font color=\"00CCCC\">%0%</font>will be used</p><p>to receive a total of<font color=\"00CCCC\">%num1 points</font>.</p><p>Do you want to use<font color=\"00CCCC\">%0%</font>?</p>";
	...
	rules[STR_POPUP_EXP_EXTRACTION_USE_ITEM_CONFIRM] = "<p>By using the item<font color=\"00CCCC\">%0</font>,</p><p>you will lose<font color=\"00CCCC\">%num1</font>Experience Points.</p><p>Do you want to use<font color=\"00CCCC\">%0</font>?</p>";
	...
	rules[STR_MSG_EVENT_DIRECT_PORTAL_OPEN_NOTICE] = "<p>You have entered the Concert Grounds.</p><p>Some functions such skills, duels and mount riding are not available in this location.</p><p>Have fun!</p>";
	...
	rules[STR_MSG_SVS_DIRECT_PORTAL_OPEN_NOTICE] = "<p>You have entered the Advance Corridor.</p><p>If the Generator is destroyed,</p><p>you will return to the place you were before entering.</p>";
	...
	rules[STR_MSG_EVENT_MSG_TEST6] = "The playing time will end shortly. Please visit the AION website if you'd like to continue playing.<a href=\"ingame_web_shop_dialog\">Open the Aion Shop</a>";
	...
	rules[STR_MSG_RVR_DIRECT_PORTAL_OPEN_NOTICE] = "<p>The battle has begun.</p><p>If you leave the battle zone, you will be sent back to your zone and dismissed from the Alliance.</p><p></p><p>You will also be excluded from the battle if you use a skill or an item to return.</p>";
	...
	rules[STR_MSG_CUSTOMIZING_SELECT_COST] = "<p>Please select a payment method. (Your Luna: %0)</p><p>(%1 Luna or Plastic Surgery Ticket)</p>";
	rules[STR_MSG_GENDER_SELECT_COST] = "<p>Please select a payment method. (Your Luna: %0)</p><p>(%1 Luna or Gender Switch Ticket)</p>";
	...
	rules[STR_MSG_QUNAMARKET_ERROR_01] = "<p>Could not connect to the shop server. (%0)</p><p>The client must be restarted for trouble-free use of the shop.</p>";
	rules[STR_MSG_QUNAMARKET_ERROR_02] = "<p>It is not currently possible to connect to the shop server.</p><p>The client must be restarted for trouble-free use of the shop.</p>";
	rules[STR_MSG_QUNAMARKET_ERROR_03] = "<p>You have been disconnected from the shop server.</p><p>The client must be restarted for trouble-free use of the shop.</p>";
