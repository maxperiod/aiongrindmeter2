...
CommandStringsEUEnglish::CommandStringsEUEnglish(){
	...
	rules[STR_SKILL_PENALTY_DEFEND] = "Reduces Physical Defence and Resist Magic";
	...
	rules[STR_POSTMAN_UNABLE_IN_FLIGHT] = "You cannot call a courierwhile flying.";
	...
	rules[STR_REMOVE_STIGMA_ENCHANT_BUFF_ALLUSER_BYEVENT] = "The %0 effect has expired. A failed Stigma Boost will result in another penalty.";
	rules[STR_MSG_STIGMA_ENCHANT_FAIL_OPTIONBUFFEVENT_STIGMA] = "The enchantment of %0% failed. The Stigma Gain effect doesn't destroy the selected Stigma, but simply decreases the boost level by 1.";
	...
	rules[STR_ABYSS_BOSS_KILLED] = "%1 of the %0 has defeated %2.";
	...
	rules[STR_MSG_DELETE_CASH_SOCIALACTION_BY_TIMEOUT] = "The usage time for the %0 emote has expired. <a href=\"ingame_web_shop_dialog\">Open Zephyr Shop</a>";
	rules[STR_MSG_DELETE_CASH_XPBOOST_BY_TIMEOUT] = "The usage time for the [Lodas Amulet] Bonus 20%% XP has expired.<a href=\"ingame_web_shop_dialog\">Open Zephyr Shop</a>";
	...
	rules[STR_MSG_ALARM_REMAIN_PLAYTIME] = "The game time will end in %*0. Please visit the AION website if you'd like to continue playing.<a href=\"ingame_web_shop_dialog\">Open Zephyr Shop</a>";
	...
	rules[STR_MSG_COUNT_REMAIN_PLAYTIME] = "The playing time has expired, and the game will end automatically in %*0. <a href=\"ingame_web_shop_dialog\">Open Zephyr Shop</a>";
	...
	rules[STR_IDSHULACKSHIP_OPEN_DOOR_01] = "Grogget's Safe door is open and you can now access Grogget's Safe.";
	rules[STR_IDSHULACKSHIP_OPEN_DOOR_02] = "The Brig door is open and you can now access The Brig.";
	rules[STR_IDSHULACKSHIP_OPEN_DOOR_03] = "The Generator Chamber access door is open and you can now access the Drana Generator Chamber.";
	rules[STR_IDSHULACKSHIP_OPEN_DOOR_04] = "The Large Gun Deck door is open and you can now access the Large Gun Deck.";
	...
	rules[STR_MSG_TOYPET_CANT_SUMMON_STATE] = "Leave %0 before summoning a pet.";
	rules[STR_MSG_TOYPET_CANT_SUMMON_ABNORMAL_STATE] = "You cannot summon a pet while in an Altered State.";
	rules[STR_MSG_TOYPET_CANT_UNSUMMON_STATE] = "You cannot dismiss a pet in %0.";
	...
	rules[STR_MSG_GIVEUP_COMBINESKILL_EXPERT_POPUP] = "<font color=\"ff0000\">Removing Expert crafting knowledge</font> will cost %0 Kinah. You will <font color=\"ff0000\">forget</font> all recipes of Skill Level 399 or higher, and all records of the quests you've done with those recipes. Are you sure you want to <font color=\"ff0000\">remove</font> Expert crafting knowledge?";
	...
	rules[STR_MSG_PET_ABANDON_EXPIRE_TIME_COMPLETE] = "The usage time of %0% has expired - the Pet has left you.<a href=\"ingame_web_shop_dialog\">Open Zephyr Shop</a>";
	...
	rules[STR_MSG_NORIDE_TIME_EXPIRE] = "The usage time of %0 expired so you climbed off your mount.<a href=\"ingame_web_shop_dialog\">Open Zephyr Shop</a>";
	...
	rules[STR_MSG_LDF4a_Raid_BattleMessage8] = "If you destroy the artefact, Muzzled Punisher will go berserk.";
	rules[STR_MSG_LDF4a_Raid_BattleMessage9] = "LDF4a_Raid_BattleMessage to indicate [%SkillCaster] (Temporary)";
	rules[STR_MSG_LDF4a_Raid_BattleMessage10] = "Look for another target.";
	...
	rules[STR_MSG_LDF4a_Lost_Guardian_Skill_Area_Middle] = "The centre ground is shaking. Move.";
	...
	rules[STR_MSG_LDF4a_windpath163_Ready] = "The generator has been destroyed, activating the wind stream.";
	...
	rules[STR_MSG_ITEM_CHARGE2_SUCCESS] = "%0 has been magically charged to Level %1.";
	...
	rules[STR_MSG_ITEM_CHARGE2_ALL_COMPLETE] = "The equipped item has been magically charged.";
	...
	rules[STR_MSG_DISABLE_IN_NOVICE_SERVER] = "This function is not available on the novice or instance servers.";
	...
	rules[IDTIAMAT_TIAMAT_ANNOUNCE_DMG_SHRING] = "The amount of damage from an opponent's area attack decreases depending on the number of targets that are attacked.";
	rules[STR_IDTIAMAT_TIAMAT_WARNING_MSG] = "Be careful! Using the magical powers of Siel's Relics, Tiamat can rebuff all attacks.";
	rules[STR_IDTIAMAT_TIAMAT_SPAWN_BLACKHOLE] = "Creating Gravity was not completed successfully within the given time and has grown into a Gravity Vortex!";
	...
	rules[STR_IDEVENT01_GOLD_MAP] = "You need the Gold Medal of the Emperor.";
	rules[STR_IDEVENT01_SILVER_MAP] = "You need the Silver Medal of the Empress.";
	rules[STR_IDEVENT01_BRONZE_MAP] = "You need the Bronze Medal of the Crown Prince.";
	rules[STR_IDEVENT01_S1_START] = "The robbers are approaching. Guard the Tombstone of the Crown Prince!";
	rules[STR_IDEVENT01_S2_START] = "The robbers are approaching. Guard the Tombstone of the Empress!";
	rules[STR_IDEVENT01_S3_START] = "The robbers are approaching. Guard the Tombstone of the Emperor!";
	rules[STR_IDEVENT01_TB_START] = "Use the key in your inventory to open the box.";
	rules[STR_IDEVENT01_PHASE] = "The 2nd wave of robbers will be here in 10 seconds!";
	rules[STR_IDEVENT01_TREASUREBOX] = "You do not have key to open the chest.";
	...
	rules[STR_IDEVENT01_PHASE02] = "The robbers will be here in 5 seconds!";
	rules[STR_IDTIAMAT_TIAMAT_REWARD_SPAWN] = "A Medal Chest appeared in the Garden of the Dragon Lord.";
	...
	rules[STR_MSG_CANNOT_POLISH_ITEM] = "%0 cannot be combined with Idian.";
	...
	rules[STR_MSG_POLISH_CHANGE_CONDITION_WRONG] = "Idian charging of %0 was reduced.";
	rules[STR_MSG_POLISH_CHANGE_CONDITION_END] = "The Idian effect of %0 has disappeared.";
	rules[STR_MSG_POLISH_CANCELED] = "Idian socketing for %0 was cancelled.";
	rules[STR_MSG_GET_ITEM_EXTRA] = "%0 has been received and stowed in the Cube for quest objects, coins and tickets.";
	rules[STR_MSG_GET_ITEM_EXTRA_MULTI] = "You received %num1 %0 and stowed them in the Cube for quest objects, coins and tickets.";
	...
	rules[STR_MSG_ITEM_SEAL_WARNING_POLISH] = "You cannot socket an Idian to a sealed item.";
	...
	rules[STR_IDEVENT01_PHASE03] = "The 3rd wave of robbers will be here in 10 seconds!";
	rules[STR_IDEVENT01_PHASE04] = "The robbers will be here in 5 seconds!";
	rules[STR_IDEVENT01_PHASE05] = "The 4th wave of robbers will be here in 10 seconds!";
	rules[STR_IDEVENT01_PHASE06] = "The robbers will be here in 5 seconds!";
	rules[STR_IDEVENT01_PHASE07] = "The 5th wave of robbers will be here in 10 seconds!";
	rules[STR_IDEVENT01_PHASE08] = "The robbers will be here in 5 seconds!";
	rules[STR_IDEVENT01_PHASE09] = "The last wave of robbers will be here in 10 seconds!";
	rules[STR_IDEVENT01_PHASE10] = "The robbers will be here in 5 seconds!";
	...
	rules[STR_MSG_POLISH_COMBAT_MODE] = "Idian socketing is not possible during a battle.";
	...
	rules[STR_MSG_POLISH_NEED_IDENTIFY] = "An enhancement with Idian is not possible until you have identified the equipment item.";
	rules[STR_MSG_POLISH_ITEM_INVALID_STANCE] = "You cannot socket Idian to %0.";
	...
	rules[STR_IDEVENT01_PHASE11] = "Bobariki has appeared!";
	rules[STR_IDEVENT01_PHASE12] = "Makekike has appeared!";
	rules[STR_IDEVENT01_PHASE13] = "Rukibuki will appear in 5 seconds!";
	...
	rules[STR_WEAPON_BOOST_CANT_START_END] = "No power shards can be activated or deactivated in this area.";
	...
	rules[STR_MSG_5011_Mercenary_Chief_01] = "The mercenaries have reached the first section of the Sillus Fortress.";
	rules[STR_MSG_5011_Mercenary_Chief_02] = "The mercenaries have reached the second section of the Sillus Fortress.";
	rules[STR_MSG_5011_Mercenary_Chief_03] = "The mercenaries have reached the third section of the Sillus Fortress.";
	rules[STR_MSG_6011_Mercenary_Chief_01] = "The mercenaries have reached the first section of the Bassen Fortress.";
	rules[STR_MSG_6011_Mercenary_Chief_02] = "The mercenaries have reached the second section of the Bassen Fortress.";
	rules[STR_MSG_6011_Mercenary_Chief_03] = "The mercenaries have reached the third section of the Bassen Fortress.";
	...
	rules[STR_MSG_LDF5_U2_E_02_Time_01_01] = "The Command Unit of the Special Research Troop has advanced towards the Resting Place of Eternity.";
	rules[STR_MSG_LDF5_U2_E_02_Time_01_02] = "The Command Unit of the Special Research Troop has discovered the Resting Place of Eternity.";
	rules[STR_MSG_LDF5_U2_E_02_Time_01_03] = "The Command Unit of the Special Research Troop has infiltrated the Resting Place of Eternity.";
	rules[STR_MSG_LDF5_U2_E_02_Time_01_04] = "The Command Unit of the Special Research Troop is collecting Rune relics.";
	rules[STR_MSG_LDF5_U2_E_02_Time_01_05] = "The entire Command Unit of the Special Research Troop has left.";
	rules[STR_MSG_LDF5_U2_E_02_Time_01_06] = "The Chira Grave Robbers have completed the mining work.";
	rules[STR_MSG_LDF5_U2_E_02_Time_01_07] = "All of the Chira Grave Robbers have disappeared.";
	...
	rules[STR_MSG_5011_Mercenary_Chief_04] = "You have spent 16 Battle Medals.";
	rules[STR_MSG_5011_Mercenary_Chief_05] = "You have spent 8 Battle Medals.";
	rules[STR_MSG_5011_Mercenary_Chief_06] = "You have spent 16 Battle Medals.";
	rules[STR_MSG_6011_Mercenary_Chief_04] = "You have spent 14 Battle Medals.";
	rules[STR_MSG_6011_Mercenary_Chief_05] = "You have spent 10 Battle Medals.";
	rules[STR_MSG_6011_Mercenary_Chief_06] = "You have spent 10 Battle Medals.";
	...
	rules[STR_MSG_LDF5a_OP_ZoneTeleporter_Q_01] = "You have spent one ancient coin.";
	rules[STR_MSG_LDF5b_sg1_ZoneTeleporter_Q_01] = "You have spent one ancient coin.";
	rules[STR_MSG_INSTANCE_OPEN_IDDREADGION_04] = "The passage to the Durga Dredgion has been opened.";
	rules[STR_MSG_INSTANCE_START_IDDREADGION_04] = "The attack on the Durga Dredgion has begun.";
	rules[STR_MSG_ALARM_COLD_GAME_IDDREADGION_04] = "The opposing faction cancelled the attack on the Durga Dredgion. You will leave this location in %DURATIONTIME0.";
	rules[STR_MSG_WAREHOUSETELEPORTER_CREATED_IDDREADGION_04_01] = "A Supply Warehouse teleporter has been generated in the Escape Hatch.";
	rules[STR_MSG_BOSS_SPAWN_IDDREADGION_04] = "Captain Anusa has showed up in the Captain's Cabin.";
	rules[STR_MSG_BONUSNPC_SPAWN_IDDREADGION_04] = "The gigantic Udara has showed up on the gravity control.";
	rules[STR_MSG_WAREHOUSETELEPORTER_CREATED_IDDREADGION_04_02] = "A teleporter for supplies has been generated near the Secondary Escape Hatch.";
	...
	rules[STR_MSG_TELEPORT_SPAWN_IDDREADGION_04] = "A main teleporter was activated near the Escape Hatch.";
	...
	rules[STR_MSG_POLISH_NEED_OPEN_PACK] = "Idian Enhancements cannot be effected on wrapped items.";
	...
	rules[STR_MSG_1221_Mercenary_Chief_01] = "Defensive Guard Towers have been raised at the eastern and western fortress gates.";
	rules[STR_MSG_1221_Mercenary_Chief_02] = "Defensive Guard Towers have been raised at the northern and southern fortress gates.";
	rules[STR_MSG_1221_Mercenary_Chief_03] = "Defensive Guard Towers have been set up in the middle of the fortress as well as on the floating island.";
	rules[STR_MSG_1221_Mercenary_Chief_04] = "You have spent 6 Battle Medals.";
	rules[STR_MSG_1221_Mercenary_Chief_05] = "You have spent 6 Battle Medals.";
	rules[STR_MSG_1221_Mercenary_Chief_06] = "You have spent 9 Battle Medals.";
	rules[STR_MSG_1231_Mercenary_Chief_01] = "Defensive Guard Towers have been raised at the northern and southern fortress gates.";
	rules[STR_MSG_1231_Mercenary_Chief_02] = "Defensive Guard Towers have been raised on the eastern and western fortress walls.";
	rules[STR_MSG_1231_Mercenary_Chief_03] = "A defensive Guard Tower has been raised in the middle of the fortress.";
	rules[STR_MSG_1231_Mercenary_Chief_04] = "You have spent 6 Battle Medals.";
	rules[STR_MSG_1231_Mercenary_Chief_05] = "You have spent 6 Battle Medals.";
	rules[STR_MSG_1231_Mercenary_Chief_06] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_1241_Mercenary_Chief_01] = "Defensive Guard Towers have been raised at the eastern and western fortress gates.";
	rules[STR_MSG_1241_Mercenary_Chief_02] = "A siege weapon has arrived in Miren Fortress Zone 2.";
	rules[STR_MSG_1241_Mercenary_Chief_03] = "A siege weapon has arrived in Miren Fortress Zone 3.";
	rules[STR_MSG_1241_Mercenary_Chief_04] = "You have spent 6 Battle Medals.";
	rules[STR_MSG_1241_Mercenary_Chief_05] = "You have spent 2 Battle Medals.";
	rules[STR_MSG_1241_Mercenary_Chief_06] = "You have spent 2 Battle Medals.";
	...
	rules[STR_MSG_ITEM_AUTHORIZE_FAILED] = "The upgrade of %0 has failed and was set to level 0.";
	...
	rules[STR_MSG_1221_Mercenary_Chief_07] = "Mercenaries have arrived at the eastern and western fortress gates.";
	rules[STR_MSG_1221_Mercenary_Chief_08] = "Mercenaries have arrived at the northern and southern fortress gates.";
	rules[STR_MSG_1221_Mercenary_Chief_09] = "Mercenaries have arrived in the middle of the fortress as well as on the floating island.";
	rules[STR_MSG_1221_Mercenary_Chief_10] = "You have spent 4 Battle Medals.";
	rules[STR_MSG_1221_Mercenary_Chief_11] = "You have spent 4 Battle Medals.";
	rules[STR_MSG_1221_Mercenary_Chief_12] = "You have spent 12 Battle Medals.";
	rules[STR_MSG_1231_Mercenary_Chief_07] = "Mercenaries have arrived at the northern and southern fortress gates.";
	rules[STR_MSG_1231_Mercenary_Chief_08] = "Mercenaries have arrived at the eastern and western fortress walls.";
	rules[STR_MSG_1231_Mercenary_Chief_09] = "Mercenaries have arrived in the middle of the fortress.";
	rules[STR_MSG_1231_Mercenary_Chief_10] = "You have spent 4 Battle Medals.";
	rules[STR_MSG_1231_Mercenary_Chief_11] = "You have spent 4 Battle Medals.";
	rules[STR_MSG_1231_Mercenary_Chief_12] = "You have spent 8 Battle Medals.";
	rules[STR_MSG_1241_Mercenary_Chief_07] = "Mercenaries have arrived at the eastern and western fortress gates.";
	rules[STR_MSG_1241_Mercenary_Chief_08] = "Mercenaries have arrived in the fortress interior.";
	rules[STR_MSG_1241_Mercenary_Chief_09] = "Mercenaries have arrived in Miren Fortress Zone 3.";
	rules[STR_MSG_1241_Mercenary_Chief_10] = "You have spent 4 Battle Medals.";
	rules[STR_MSG_1241_Mercenary_Chief_11] = "You have spent 4 Battle Medals.";
	rules[STR_MSG_1241_Mercenary_Chief_12] = "You have spent 2 Battle Medals.";
	rules[STR_MSG_AB1_PCTank_NoItem] = "You require fuel to be able to use the tank.";
	...
	rules[STR_MSG_GIVE_ITEM_TYPE_OPTION_NEED_IDENTIFY] = "Enchantment is not possible until you have identified the equipment item.";
	...
	rules[STR_MSG_GAB1_SUB_ALARM_01] = "The Protective Guard in the Advance Corridor is being prepared. Please wait a moment.";
	rules[STR_MSG_GAB1_SUB_ALARM_02] = "The gate to Antriksha's Ascension Site will open in 8 minutes.";
	rules[STR_MSG_GAB1_SUB_ALARM_03] = "The gate to Antriksha's Ascension Site will open in 6 minutes.";
	rules[STR_MSG_GAB1_SUB_ALARM_04] = "The gate to Antriksha's Ascension Site will open in 4 minutes.";
	rules[STR_MSG_GAB1_SUB_ALARM_05] = "The gate to Antriksha's Ascension Site will open in 2 minutes.";
	rules[STR_MSG_GAB1_SUB_ALARM_06] = "The gate to Antriksha's Ascension Site will open in one minute.";
	rules[STR_MSG_GAB1_SUB_TANK_A_ATTACKED] = "The 1st Tank Fleet controller is under attack.";
	rules[STR_MSG_GAB1_SUB_TANK_B_ATTACKED] = "The 2nd Tank Fleet controller is under attack.";
	rules[STR_MSG_GAB1_SUB_TANK_C_ATTACKED] = "The 3rd Flame Tank Fleet controller is under attack.";
	rules[STR_MSG_GAB1_SUB_TANK_D_ATTACKED] = "The 4th Flame Tank Fleet controller is under attack.";
	rules[STR_MSG_GAB1_SUB_TANK_A_BROKEN] = "The 1st Tank Fleet controller was destroyed.";
	rules[STR_MSG_GAB1_SUB_TANK_B_BROKEN] = "The 2nd Tank Fleet controller was destroyed.";
	rules[STR_MSG_GAB1_SUB_TANK_C_BROKEN] = "The 3rd Flame Tank Fleet controller was destroyed.";
	rules[STR_MSG_GAB1_SUB_TANK_D_BROKEN] = "The 4th Flame Tank Fleet controller was destroyed.";
	rules[STR_MSG_GAB1_SUB_PORTAL_DEST_69_ATTACKED] = "The Belus Barrier in the Advance Corridor is under attack.";
	rules[STR_MSG_GAB1_SUB_PORTAL_DEST_70_ATTACKED] = "The Aspida Barrier in the Advance Corridor is under attack.";
	rules[STR_MSG_GAB1_SUB_PORTAL_DEST_71_ATTACKED] = "The Athanos Barrier in the Advance Corridor is under attack.";
	rules[STR_MSG_GAB1_SUB_PORTAL_DEST_72_ATTACKED] = "The Deylon Barrier in the Advance Corridor is under attack.";
	rules[STR_MSG_GAB1_SUB_PORTAL_DEST_69_BROKEN] = "The Belus Barrier in the Advance Corridor was destroyed. The Belus Faction Daevas have returned to the Fortress of Change.";
	rules[STR_MSG_GAB1_SUB_PORTAL_DEST_70_BROKEN] = "The Aspida Barrier in the Advance Corridor is under attack. The Aspida Faction Daevas have returned to the Iron Fortress.";
	rules[STR_MSG_GAB1_SUB_PORTAL_DEST_71_BROKEN] = "The Athanos Barrier in the Advance Corridor is under attack. The Athanos Faction Daevas have returned to the Fortress of Eternity.";
	rules[STR_MSG_GAB1_SUB_PORTAL_DEST_72_BROKEN] = "The Deylon Barrier in the Advance Corridor was destroyed. The Deylon Faction Daevas have returned to the Ruined Fortress.";
	...
	rules[STR_MSG_2011_Mercenary_Chief_01] = "The mercenaries have arrived on the First Floor.";
	rules[STR_MSG_2011_Mercenary_Chief_02] = "The mercenaries have arrived in the left area of the First Floor.";
	rules[STR_MSG_2011_Mercenary_Chief_03] = "The mercenaries have arrived in the right area of the First Floor.";
	rules[STR_MSG_2011_Mercenary_Chief_04] = "The mercenaries have arrived in the middle of the First Floor.";
	rules[STR_MSG_2011_Mercenary_Chief_05] = "The mercenaries have arrived on the Second Floor.";
	rules[STR_MSG_2011_Mercenary_Chief_06] = "Mercenaries have arrived on the Second Floor of the middle of the outer area of the Fortress.";
	rules[STR_MSG_2011_Mercenary_Chief_07] = "Mercenaries have arrived at the entrance to the fortress on the Second Floor.";
	rules[STR_MSG_2011_Mercenary_Chief_08] = "A Defence Tower was constructed to the right of the entrance on the Second Floor.";
	rules[STR_MSG_2011_Mercenary_Chief_09] = "A Defence Tower was constructed to the left of the entrance on the Second Floor.";
	rules[STR_MSG_2011_Mercenary_Chief_11] = "You have spent 11 Battle Medals.";
	rules[STR_MSG_2011_Mercenary_Chief_12] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2011_Mercenary_Chief_13] = "You have spent 2 Battle Medals.";
	rules[STR_MSG_2011_Mercenary_Chief_14] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2011_Mercenary_Chief_15] = "You have spent 6 Battle Medals.";
	rules[STR_MSG_2011_Mercenary_Chief_16] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2011_Mercenary_Chief_17] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2011_Mercenary_Chief_18] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2011_Mercenary_Chief_19] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2021_Mercenary_Chief_01] = "Mercenaries have arrived on the First Floor.";
	rules[STR_MSG_2021_Mercenary_Chief_02] = "Mercenaries have arrived in the left area of the First Floor.";
	rules[STR_MSG_2021_Mercenary_Chief_03] = "Mercenaries have arrived in the right area of the First Floor.";
	rules[STR_MSG_2021_Mercenary_Chief_04] = "Mercenaries have arrived in the middle of the First Floor.";
	rules[STR_MSG_2021_Mercenary_Chief_05] = "Mercenaries have arrived on the Second Floor.";
	rules[STR_MSG_2021_Mercenary_Chief_06] = "Mercenaries have arrived on the Second Floor of the middle of the outer area of the Fortress.";
	rules[STR_MSG_2021_Mercenary_Chief_07] = "Mercenaries have arrived at the entrance to the fortress on the Second Floor.";
	rules[STR_MSG_2021_Mercenary_Chief_08] = "A Defence Tower was constructed to the right of the entrance on the Second Floor.";
	rules[STR_MSG_2021_Mercenary_Chief_09] = "A Defence Tower was constructed to the left of the entrance on the Second Floor.";
	rules[STR_MSG_2021_Mercenary_Chief_11] = "You have spent 11 Battle Medals.";
	rules[STR_MSG_2021_Mercenary_Chief_12] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2021_Mercenary_Chief_13] = "You have spent 2 Battle Medals.";
	rules[STR_MSG_2021_Mercenary_Chief_14] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2021_Mercenary_Chief_15] = "You have spent 6 Battle Medals.";
	rules[STR_MSG_2021_Mercenary_Chief_16] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2021_Mercenary_Chief_17] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2021_Mercenary_Chief_18] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_2021_Mercenary_Chief_19] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3011_Mercenary_Chief_01] = "Mercenaries have arrived on the First Floor.";
	rules[STR_MSG_3011_Mercenary_Chief_02] = "Mercenaries have arrived in the left area of the First Floor.";
	rules[STR_MSG_3011_Mercenary_Chief_03] = "Mercenaries have arrived in the right area of the First Floor.";
	rules[STR_MSG_3011_Mercenary_Chief_04] = "Mercenaries have arrived in the middle of the First Floor.";
	rules[STR_MSG_3011_Mercenary_Chief_05] = "Mercenaries have arrived on the Second Floor.";
	rules[STR_MSG_3011_Mercenary_Chief_06] = "Mercenaries have arrived on the Second Floor of the middle of the outer area of the Fortress.";
	rules[STR_MSG_3011_Mercenary_Chief_07] = "Mercenaries have arrived at the entrance to the fortress on the Second Floor.";
	rules[STR_MSG_3011_Mercenary_Chief_08] = "A Defence Tower was constructed to the right of the entrance on the Second Floor.";
	rules[STR_MSG_3011_Mercenary_Chief_09] = "A Defence Tower was constructed to the left of the entrance on the Second Floor.";
	rules[STR_MSG_3011_Mercenary_Chief_11] = "You have spent 11 Battle Medals.";
	rules[STR_MSG_3011_Mercenary_Chief_12] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3011_Mercenary_Chief_13] = "You have spent 2 Battle Medals.";
	rules[STR_MSG_3011_Mercenary_Chief_14] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3011_Mercenary_Chief_15] = "You have spent 6 Battle Medals.";
	rules[STR_MSG_3011_Mercenary_Chief_16] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3011_Mercenary_Chief_17] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3011_Mercenary_Chief_18] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3011_Mercenary_Chief_19] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3021_Mercenary_Chief_01] = "Mercenaries have arrived on the First Floor.";
	rules[STR_MSG_3021_Mercenary_Chief_02] = "Mercenaries have arrived in the left area of the First Floor.";
	rules[STR_MSG_3021_Mercenary_Chief_03] = "Mercenaries have arrived in the right area of the First Floor.";
	rules[STR_MSG_3021_Mercenary_Chief_04] = "Mercenaries have arrived in the middle of the First Floor.";
	rules[STR_MSG_3021_Mercenary_Chief_05] = "Mercenaries have arrived on the Second Floor.";
	rules[STR_MSG_3021_Mercenary_Chief_06] = "Mercenaries have arrived on the Second Floor of the middle of the outer area of the Fortress.";
	rules[STR_MSG_3021_Mercenary_Chief_07] = "Mercenaries have arrived at the entrance to the fortress on the Second Floor.";
	rules[STR_MSG_3021_Mercenary_Chief_08] = "A Defence Tower was constructed to the right of the entrance on the Second Floor.";
	rules[STR_MSG_3021_Mercenary_Chief_09] = "A Defence Tower was constructed to the left of the entrance on the Second Floor.";
	rules[STR_MSG_3021_Mercenary_Chief_11] = "You have spent 11 Battle Medals.";
	rules[STR_MSG_3021_Mercenary_Chief_12] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3021_Mercenary_Chief_13] = "You have spent 2 Battle Medals.";
	rules[STR_MSG_3021_Mercenary_Chief_14] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3021_Mercenary_Chief_15] = "You have spent 6 Battle Medals.";
	rules[STR_MSG_3021_Mercenary_Chief_16] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3021_Mercenary_Chief_17] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3021_Mercenary_Chief_18] = "You have spent 3 Battle Medals.";
	rules[STR_MSG_3021_Mercenary_Chief_19] = "You have spent 3 Battle Medals.";
	...
	rules[STR_REGISTER_ITEM_MSG_UPGRADE_CANNOT] = "The Equipment Blessing is only possible for items with an Enchantment Level of %0 or higher.";
	rules[STR_REGISTER_ITEM__MSG_UPGRADE_ERROR] = "This item cannot be blessed. (%0)";
	...
	rules[STR_MSG_LDF5_Fortress_Li_Center] = "The Elyos have captured the Heroic Ruins Defensive Base.";
	rules[STR_MSG_LDF5_Fortress_Li_Up] = "The Elyos have captured the Flaming Eye Defensive Base.";
	rules[STR_MSG_LDF5_Fortress_Li_Down] = "The Elyos have captured the Crater of Flames Defensive Base.";
	rules[STR_MSG_LDF5_Fortress_Da_Center] = "The Asmodians have captured the Heroic Ruins Defensive Base.";
	rules[STR_MSG_LDF5_Fortress_Da_Up] = "The Asmodians have captured the Flaming Eye Defensive Base.";
	rules[STR_MSG_LDF5_Fortress_Da_Down] = "The Asmodians have captured the Crater of Flames Defensive Base.";
	rules[STR_MSG_LDF5_Fortress_Dr_Center] = "The Balaur have captured the Heroic Ruins Defensive Base.";
	rules[STR_MSG_LDF5_Fortress_Dr_Up] = "The Balaur have captured the Flaming Eye Defensive Base.";
	rules[STR_MSG_LDF5_Fortress_Dr_Down] = "The Balaur have captured the Crater of Flames Defensive Base.";
	rules[STR_MSG_LDF5_Fortress_Li_Heal1_Start] = "Level 1 of the Flame of Healing (Elyos) is activated.";
	rules[STR_MSG_LDF5_Fortress_Li_Heal2_Start] = "Level 2 of the Flame of Healing (Elyos) is activated.";
	rules[STR_MSG_LDF5_Fortress_Li_Heal3_Start] = "Level 3 of the Flame of Healing (Elyos) is activated.";
	rules[STR_MSG_LDF5_Fortress_Li_Heal1_End] = "Level 1 of the Flame of Healing (Elyos) is stopped.";
	rules[STR_MSG_LDF5_Fortress_Li_Heal2_End] = "Level 2 of the Flame of Healing (Elyos) is stopped.";
	rules[STR_MSG_LDF5_Fortress_Li_Heal3_End] = "Level 3 of the Flame of Healing (Elyos) is stopped.";
	rules[STR_MSG_LDF5_Fortress_Da_Heal1_Start] = "Level 1 of the Flame of Healing (Asmodians) is activated.";
	rules[STR_MSG_LDF5_Fortress_Da_Heal2_Start] = "Level 2 of the Flame of Healing (Asmodians) is activated.";
	rules[STR_MSG_LDF5_Fortress_Da_Heal3_Start] = "Level 3 of the Flame of Healing (Asmodians) is activated.";
	rules[STR_MSG_LDF5_Fortress_Da_Heal1_End] = "Level 1 of the Flame of Healing (Asmodians) is activated.";
	rules[STR_MSG_LDF5_Fortress_Da_Heal2_End] = "Level 2 of the Flame of Healing (Asmodians) is stopped.";
	rules[STR_MSG_LDF5_Fortress_Da_Heal3_End] = "Level 3 of the Flame of Healing (Asmodians) is stopped.";
	rules[STR_MSG_LDF5_Fortress_Named_Spawn] = "Seal Breaker";
	rules[STR_MSG_LDF5_Fortress_Named_Spawn_Item] = "Anoha's Runeseal Stone was used to undo the seal.";
	...
	rules[STR_MSG_Anoha_Spawn] = "Summon Raging Anoha";
	rules[STR_MSG_Anoha_Die] = "You defeated Raging Anoha.";
	rules[STR_MSG_Anoha_DeSpawn] = "Raging Anoha has disappeared.";
	rules[STR_MSG_LDF4_Advance_chief_v01] = "A battle is being fought at the Western Supply Base.";
	rules[STR_MSG_LDF4_Advance_chief_v02] = "A battle is being fought at the Northern Supply Base.";
	rules[STR_MSG_LDF4_Advance_chief_v03] = "A battle is being fought at the Northern Guard Post.";
	rules[STR_MSG_LDF4_Advance_chief_v04] = "A battle is being fought at the Northern Operations Base.";
	rules[STR_MSG_LDF4_Advance_chief_v05] = "A battle is being fought at the Eastern Operations Base.";
	rules[STR_MSG_LDF4_Advance_chief_v06] = "A battle is being fought at the Eastern Guard Post.";
	rules[STR_MSG_LDF4_Advance_chief_v07] = "A battle is being fought at the Eastern Supply Base.";
	rules[STR_MSG_LDF4_Advance_chief_v08] = "A battle is being fought at the Southern Supply Base.";
	rules[STR_MSG_LDF4_Advance_chief_v09] = "A battle is being fought at the Southern Guard Post.";
	rules[STR_MSG_LDF4_Advance_chief_v10] = "A battle is being fought at the Western Operations Base.";
	rules[STR_MSG_LDF4_Advance_chief_v11] = "A battle is being fought at the Western Guard Post.";
	rules[STR_MSG_LDF4_Advance_chief_v12] = "A battle is being fought at the Southern Operations Base.";
	rules[STR_MSG_LDF4_Advance_chief_v13] = "A battle is being fought at the Central Base.";
	rules[STR_MSG_LDF4_Advance_killer_v01] = "An Assassin appeared at the Western Supply Base.";
	rules[STR_MSG_LDF4_Advance_killer_v02] = "An Assassin appeared at the Northern Supply Base.";
	rules[STR_MSG_LDF4_Advance_killer_v03] = "An Assassin appeared at the Northern Guard Post.";
	rules[STR_MSG_LDF4_Advance_killer_v04] = "An Elite Assassin appeared at the Northern Operations Base.";
	rules[STR_MSG_LDF4_Advance_killer_v05] = "An Assassin appeared at the Eastern Operations Base.";
	rules[STR_MSG_LDF4_Advance_killer_v06] = "An Assassin appeared at the Eastern Guard Post.";
	rules[STR_MSG_LDF4_Advance_killer_v07] = "An Assassin appeared at the Eastern Supply Base.";
	rules[STR_MSG_LDF4_Advance_killer_v08] = "An Assassin appeared at the Southern Supply Base.";
	rules[STR_MSG_LDF4_Advance_killer_v09] = "An Assassin appeared at the Southern Guard Post.";
	rules[STR_MSG_LDF4_Advance_killer_v10] = "An Assassin appeared at the Western Operations Base.";
	rules[STR_MSG_LDF4_Advance_killer_v11] = "An Assassin appeared at the Western Guard Post.";
	rules[STR_MSG_LDF4_Advance_killer_v12] = "An Elite Assassin appeared at the Southern Operations Base.";
	rules[STR_MSG_LDF4_Advance_killer_v13] = "An Elite Assassin appeared at the Central Base.";
	rules[STR_ABYSS_OCCUPY_COUNT_MAX] = "%0% has achieved the maximum number of conquests and will belong to the Balaur during the next Fortress Battle.";
	rules[STR_ABYSS_OCCUPY_CHANGE_DRAGON] = "%0% has achieved the maximum number of conquests and now belongs to the Balaur.";
	...
	rules[STR_MSG_LDF4_Advance_FNamed_Fail] = "You need a Relic of the Ancestors to activate the Ancient Obelisk.";
	rules[STR_MSG_LDF4_Advance_FNamed_Spawn] = "An ancient monster has appeared.";
	rules[STR_MSG_LDF4_Advance_FNamed_Spawn_Item] = "You used a Relic of the Ancestors.";
	rules[STR_MSG_LDF5_Fortress_RuneElite] = "Legions Raid";
	rules[STR_MSG_LDF4_Advance_GodElite] = "The Agent has appeared.";
	rules[STR_MSG_LDF4_Advance_GodElite_time_01] = "The Agents' Battle will last another 10 minutes.";
	rules[STR_MSG_LDF4_Advance_GodElite_time_02] = "The Agents' Battle will last another 5 minutes.";
	rules[STR_MSG_LDF4_Advance_GodElite_time_03] = "The Agents' Battle is over.";
	...
	rules[STR_MSG_LDF4_Advance_GodElite_test] = "The Agent has appeared.";
	rules[STR_ITEM_UPGRADE_MSG_UPGRADE_SUCCESS] = "You obtained %1% from the Equipment Blessing for %0.";
	...
	rules[STR_MSG_LDF5_Fortress_Named_Spawn_System] = "Raging Anoha will be summoned in 30 minutes.";
	rules[STR_MSG_GACHA_TIME_END] = "The Shugo Game has expired. Try again next time.";
	rules[STR_MSG_GAB1_SUB_ALARM_07] = "The gate to Antriksha's Ascension Site will open in 30 seconds.";
	rules[STR_MSG_GAB1_SUB_ALARM_08] = "The gate to Antriksha's Ascension Site is open.";
	...
	rules[STR_MSG_LDF4_Advance_Summon_Named_Time] = "The Ancient Monster is preparing for its return.";
	rules[STR_MSG_GACHA_ITEM_USE] = "You used %0.";
	rules[STR_MSG_GACHA_ITEM_USE_MULTI] = "You used %1%0.";
	rules[STR_MSG_BUFF_PET_USE_START_MESSAGE] = "Activates the Cheer skill. If needed, any Aether Cherries in the Inventory are used automatically.";
	rules[STR_MSG_BUFF_PET_USE_STOP_MESSAGE] = "Deactivates the Cheer skill.";
	rules[STR_MSG_GACHA_FEVERTIME_START] = "Nyerk Fever!";
	rules[STR_MSG_Gab1_START01] = "The Advance Corridor to the Pangaea Fortress Battle closes in 10 minutes.";
	rules[STR_MSG_Gab1_START02] = "The Advance Corridor to the Pangaea Fortress Battle closes in 5 minutes.";
	rules[STR_MSG_Gab1_START03] = "The Advance Corridor to the Pangaea Fortress Battle closes in 1 minute.";
	rules[STR_MSG_Gab1_START04] = "The Advance Corridor to the Pangaea Fortress Battle closes in 10 seconds.";
	rules[STR_MSG_Gab1_START05] = "The Advance Corridor gate to the Pangaea Fortress Battle has closed.";
	...
	rules[STR_MSG_LDF5_Gab1_End01] = "The Advance Corridor to the Pangaea Fortress Battle closes in 5 minutes.";
	rules[STR_MSG_LDF5_Gab1_End02] = "The Advance Corridor to the Pangaea Fortress Battle closes in 3 minutes.";
	rules[STR_MSG_LDF5_Gab1_End03] = "The Advance Corridor leading to the Pangaea Fortress Battle will close in one minute.";
	rules[STR_MSG_LDF5_Gab1_End04] = "The Advance Corridor leading to the Pangaea Fortress Battle will close in 10 seconds.";
	rules[STR_MSG_LDF5_Gab1_End05] = "The Advance Corridor leading to the Pangaea Fortress Battle has been closed.";
	...
	rules[STR_MSG_BUFF_PET_USE_STOP_MESSAGE_02] = "Cheering stopped because all the Aether Cherries have been used.";
	rules[STR_MSG_GAB1_SUB_ALARM_09] = "The Protective Guard in the Advance Corridor is ready for action. If it is destroyed, the Advance Corridor will disappear and you can go back to the fortress.";
	rules[STR_MSG_GAB1_SUB_ALARM_10] = "Antriksha's Ascension weakened the Fleet Barricade.";
	rules[STR_MSG_GAB1_SUB_ALARM_11] = "Antriksha's Ascension weakened the Chamber Boundary Wall.";
	rules[STR_MSG_GAB1_SUB_ALARM_12] = "Antriksha's Ascension weakened the Security Perimeter Barrier.";
	rules[STR_MSG_GAB1_SUB_ALARM_13] = "The Athanos Protective Guard in the Advance Corridor will disappear shortly.";
	rules[STR_MSG_GAB1_SUB_ALARM_14] = "You return to the fortress shortly.";
	rules[STR_MSG_Gab1_RebirthMa_De_01] = "The Resurrection Device of the Fortress was destroyed. If one more is destroyed, you will not be able to resurrect inside the fortress again.";
	rules[STR_MSG_Gab1_RebirthMa_De_02] = "All Resurrection Devices of the Fortress have been destroyed. After their demise, the faction defending the fortress will return to their location prior to entering.";
	rules[STR_MSG_Gab1_RebirthMa_Att_01] = "The Resurrection Device of the 1st Refuge was destroyed. After their demise, the faction whose device was destroyed will return to their location prior to entering.";
	rules[STR_MSG_Gab1_RebirthMa_Att_02] = "The Resurrection Device of the 2nd Refuge was destroyed. After their demise, the faction whose device was destroyed will return to their location prior to entering.";
	rules[STR_MSG_Gab1_RebirthMa_Att_03] = "The Resurrection Device of the 3rd Refuge was destroyed. After their demise, the faction whose device was destroyed will return to their location prior to entering.";
	rules[STR_MSG_Gab1_RebirthMa_Att_04] = "The Resurrection Device of the 4th Refuge was destroyed. After their demise, the faction whose device was destroyed will return to their location prior to entering.";
	rules[STR_MSG_Gab1_RebirthDoor_ATTACKED] = "The Defence Gate of the Resurrection Device of the Fortress is under attack.";
	...
	rules[STR_MSG_Gab1_RebirthDoor_ATTACKED_01] = "The Defence Gate of the Resurrection Device of the 1st Refuge is under attack.";
	rules[STR_MSG_Gab1_RebirthDoor_ATTACKED_02] = "The Defence Gate of the Resurrection Device of the 2nd Refuge is under attack.";
	rules[STR_MSG_Gab1_RebirthDoor_ATTACKED_03] = "The Defence Gate of the Resurrection Device of the 3rd Refuge is under attack.";
	rules[STR_MSG_Gab1_RebirthDoor_ATTACKED_04] = "The Defence Gate of the Resurrection Device of the 4th Refuge is under attack.";
	rules[STR_MSG_EXCEED_CANNOT_REGISTER] = "An evolution can be done either with %0 or with an Evolution Stone!";
	rules[STR_MSG_BUFF_PET_USE_STOP_MESSAGE_03] = "You need Aether Cherries to use the Cheer skill.";
	...
	rules[STR_IDSweep_Gate01] = "There are intruders in the Gold Vault!";
	rules[STR_IDSweep_Stage2_Phase01] = "Mirez appeared!";
	rules[STR_IDSweep_Stage2_Phase02] = "Jodika appeared!";
	rules[STR_IDSweep_Stage2_Phase03] = "Bendy appeared!";
	rules[STR_IDSweep_Stage2_End] = "The intruders have fled.";
	rules[STR_MSG_AB1_BombNotice] = "A bomb was placed to destroy the fortress gate.";
	rules[STR_MSG_AB1_BombAlarm] = "Your enemies detonate a bomb to destroy the gate to the fortress.";
	rules[STR_MSG_AB1_BombExplosion] = "A bomb to destroy the fortress gate has exploded.";
	rules[STR_IDSweep_Stage2_Phase04] = "Lupasha appeared!";
	rules[STR_IDSweep_Stage2_Phase05] = "Commander Grodi appeared!";
	rules[STR_IDSweep_Stage2_Bomb] = "You can use explosives.";
	...
	rules[STR_MSG_TOPPING_NOTICE_EXPIRE_TIME] = "The %1 effect will end in %DURATIONDAY0.<a href=\"ingame_web_shop_dialog\">Open Zephyr Shop</a>";
	...
	rules[STR_MSG_OBJ_Die] = "The Guardian Stone was attacked and has exploded.";
	rules[STR_MSG_OBJ_Stay] = "All opponents who attacked the Guardian Stone have disappeared.";
	rules[STR_MSG_GUILD_APPLY_DOMINION] = "You have applied to participate in the Legion Territory Battle in %0.";
	...
	rules[STR_MSG_GUILD_DOMINION_WIN_NOTICE] = "The %0 Legion has captured %1.";
	...
	rules[STR_MSG_OBJ_Start] = "Defend the Guardian Stone for 2 minutes.";
	rules[STR_MSG_OBJ_End] = "You have successfully protected the Guardian Stone.";
	rules[STR_MSG_DF4_Rotation_Spawn] = "A monster has appeared.";
	rules[STR_MSG_LF4_Rotation_Spawn] = "A monster has appeared.";
	rules[STR_MSG_STIGMA_ENCHANT_SUCCESS] = "Equipping %0 was successful. The skill level was increased by 1.";
	rules[STR_MSG_STIGMA_ENCHANT_FAIL] = "Equipping %0 failed. The Stigma was destroyed.";
	...
	rules[STR_MSG_STIGMA_ENCHANT_HIDDEN_SKILL] = "The skill level of %0 has been upgraded to %1.";
	...
	rules[STR_SKILL_SUCC_DispelAllCounterATK_ME_TO_SELF] = "You suffered %num0 damage and lost some of your magical buffs and debuffs because [%SkillName] was used on you.";
	...
	rules[STR_IDElemental_2_E_MeleeGolem_Object_Fail] = "You have no fuel to operate the unloaded Hetgolem.";
	rules[STR_IDElemental_2_E_MeleeGolem_Object_Succe] = "The Hetgolem moves.";
	rules[STR_IDElemental_2_E_MeleeGolem_Object_Use] = "You used the fuel.";
	...
	rules[STR_MSG_LDF5_Gab1_End06] = "The Corridor of Heroic Deeds leading to the Pangaea Fortress Battle closes in 5 minutes.";
	rules[STR_MSG_LDF5_Gab1_End07] = "The Corridor of Heroic Deeds leading to the Pangaea Fortress Battle closes in 3 minutes.";
	rules[STR_MSG_LDF5_Gab1_End08] = "The Corridor of Heroic Deeds leading to the Pangaea Fortress Battle will close in 1 minute.";
	rules[STR_MSG_LDF5_Gab1_End09] = "The Corridor of Heroic Deeds leading to the Pangaea Fortress Battle will close in 10 seconds.";
	rules[STR_MSG_LDF5_Gab1_End10] = "The Corridor of Heroic Deeds leading to the Pangaea Fortress Battle has been closed.";
	rules[STR_MSG_INSTANCE_START_IDElemental_2_E] = "You start by investigating the cursed Argent Manor.";
	rules[STR_MSG_LDF5_Gab1_End11] = "The Corridor of Heroic Deeds leading to the Pangaea Fortress Battle has been opened.";
	...
	rules[STR_REGISTER_ITEM_MSG_UPGRADE_CANNOT_02] = "Equipment Blessing is only possible for items that have been improved to a level of %0 or higher.";
	rules[STR_MSG_Ab1_Fortress_Entrance_In01] = "You cannot enter because you have not reached Rank 65 yet.";
	rules[STR_MSG_Ab1_Fortress_Entrance_In02] = "You cannot use this as long as you are alone.";
	rules[STR_MSG_Ab1_Named_Spawn_Fail01] = "You cannot break the seal without the Krotan Pendant.";
	rules[STR_MSG_Ab1_Named_Spawn_Fail02] = "You cannot break the seal without the Kysis Pendant.";
	rules[STR_MSG_Ab1_Named_Spawn_Fail03] = "You cannot break the seal without the Miren Pendant.";
	rules[STR_MSG_Ab1_Crotan_Named_Spawn] = "Dissolve Krotan Seal";
	rules[STR_MSG_Ab1_Crotan_Named_Spawn_System] = "The Krotan Protector will be summoned from the Crystal Sword in 30 minutes.";
	rules[STR_MSG_Ab1_Crotan_Named_Spawn_Item] = "You used the Krotan Pendant to lift the seal.";
	rules[STR_MSG_Ab1_Lamiren_Named_Spawn] = "Dissolve Miren Seal";
	rules[STR_MSG_Ab1_Lamiren_Named_Spawn_System] = "The Miren Protector will be summoned from the Crystal Sword in 30 minutes.";
	rules[STR_MSG_Ab1_Lamiren_Named_Spawn_Item] = "You used the Miren Pendant to lift the seal.";
	rules[STR_MSG_Ab1_Dkisas_Named_Spawn] = "Dissolve Kysis Seal";
	rules[STR_MSG_Ab1_Dkisas_Named_Spawn_System] = "The Kysis Protector will be summoned from the Crystal Sword in 30 minutes.";
	rules[STR_MSG_Ab1_Dkisas_Named_Spawn_Item] = "You used the Kysis Pendant to lift the seal.";
	...
	rules[STR_MSG_ACCUSE_CANT_FLY_INVITE] = "You cannot invite the selected player because they are currently fleeing.";
	...
	rules[STR_MSG_GUILD_PROCESS] = "Your Legion application is being processed.";
	rules[STR_MSG_GUILD_CANT_JOIN] = "You cannot apply to join a Legion.";
	rules[STR_MSG_GUILD_CANT_JOIN_MAX_LEVEL] = "You cannot apply to join the Legion until you have reached the Legion's minimum level.";
	rules[STR_MSG_GUILD_CANT_JOIN_PROCESS_CHANGE] = "The registration method for this Legion has been changed.";
	rules[STR_MSG_GUILD_CANT_JOIN_MAX_MEMBER] = "This Legion has reached the maximum number of members and cannot accept any further applications.";
	rules[STR_MSG_GUILD_JOIN_CANT_CANCEL] = "You cannot withdraw your application once you are accepted into a Legion.";
	rules[STR_MSG_GUILD_REJECT_INVITE_CANT_CANCEL] = "You cannot withdraw your application once your Legion application has been rejected.";
	rules[STR_MSG_GUILD_INVITE_HE_JOINED_CANCEL] = "The player has withdrawn their Legion registration.";
	rules[STR_MSG_GUILD_APPLICANT_MAX] = "This Legion has reached the maximum number of applicants and cannot accept any further applications.";
	rules[STR_MSG_GUILD_APPLICANT_CANT_JOIN] = "You cannot accept Legion invitations while you have an application pending for membership in another Legion.";
	rules[STR_MSG_GUILD_APPLICANT_CANT_CREATE] = "You cannot establish your own Legion if you apply for membership of a Legion. You cannot establish one until you withdraw your application.";
	...
	rules[STR_MSG_GUILD_APPLIACNT_CANT_SELECT_MAX] = "The selected players cannot join because the maximum number of Legion members has been reached.";
	...
	rules[STR_GUILD_JOIN_CANNOT_JOIN] = "You cannot join another Legion for %1 minutes and %2 seconds following the Legion application.";
	...
	rules[STR_MSG_GUILD_APPLICANT_SELECT_MAX] = "The maximum number of members for a Legion cannot be exceeded.";
	...
	rules[STR_MSG_GUILD_INVITE_HE_JOINED_CANCEL_2] = "%0 is a deleted character.";
	...
	rules[STR_MSG_EVENT_MSG_TEST6] = "The game time will end shortly. Please visit the AION website if you'd like to continue playing. <a href=\"ingame_web_shop_dialog\">Open Zephyr Shop</a>";
	...
	rules[STR_MSG_Ab1_Crotan_Named_Spawn_In] = "The Krotan Protector appears.";
	rules[STR_MSG_Ab1_Lamiren_Named_Spawn_In] = "The Miren Protector appears.";
	rules[STR_MSG_Ab1_Dkisas_Named_Spawn_In] = "The Kysis Protector appears.";
	...
	rules[STR_MSG_DF6_B_G2_Spawn] = "The Elyos Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_DF6_B2_G2_Spawn] = "The Elyos Attack Squad ships have reached the Sky Islands.";
	rules[STR_MSG_DF6_C_G2_Spawn] = "The Elyos Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_DF6_D_G2_Spawn] = "The Elyos Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_DF6_E_G2_Spawn] = "The Elyos Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_DF6_F_G2_Spawn] = "The Elyos Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_DF6_F2_G2_Spawn] = "The Elyos Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_DF6_G_G2_Spawn] = "The Elyos Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_DF6_H_G2_Spawn] = "The Elyos Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_DF6_I_G2_Spawn] = "The Elyos Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_LF6_B_G2_Spawn] = "The Asmodian Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_LF6_B2_G2_Spawn] = "The Asmodian Attack Squad ships have reached the Sky Islands.";
	rules[STR_MSG_LF6_C_G2_Spawn] = "The Asmodian Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_LF6_D_G2_Spawn] = "The Asmodian Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_LF6_E_G2_Spawn] = "The Asmodian Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_LF6_F_G2_Spawn] = "The Asmodian Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_LF6_F2_G2_Spawn] = "The Asmodian Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_LF6_G_G2_Spawn] = "The Asmodian Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_LF6_H_G2_Spawn] = "The Asmodian Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_LF6_I_G2_Spawn] = "The Asmodian Attack Squad ships will soon reach the Sky Islands.";
	rules[STR_MSG_DF6_G1_Spawn_05] = "Invasion of the Elyos Fleet";
	rules[STR_MSG_LF6_G1_Spawn_05] = "Invasion of the Asmodian Fleet";
	...
	rules[STR_MSG_DF6_G1_Spawn_01] = "The Elyos Invasion Fleet will invade in 10 minutes.";
	rules[STR_MSG_DF6_G1_Spawn_02] = "The Elyos Invasion Fleet will invade in 5 minutes.";
	rules[STR_MSG_DF6_G1_Spawn_03] = "The Elyos Invasion Fleet will invade in 3 minutes.";
	rules[STR_MSG_DF6_G1_Spawn_04] = "The Elyos Invasion Fleet will invade in 1 minute.";
	rules[STR_MSG_LF6_G1_Spawn_01] = "The Asmodian Invasion Fleet will invade in 10 minutes.";
	rules[STR_MSG_LF6_G1_Spawn_02] = "The Asmodian Invasion Fleet will invade in 5 minutes.";
	rules[STR_MSG_LF6_G1_Spawn_03] = "The Asmodian Invasion Fleet will invade in 3 minutes.";
	rules[STR_MSG_LF6_G1_Spawn_04] = "The Asmodian Invasion Fleet will invade in 1 minute.";
	...
	rules[STR_MSG_DF6_G2_Event_Start] = "The Elyos Fleet will be here soon.";
	rules[STR_MSG_LF6_G2_Event_Start] = "The Asmodian Fleet will arrive soon.";
	...
	rules[STR_IDEternity_01_Shield] = "You can enter as soon as you've destroyed the Power Generators and thus deactivated the Protective Shield.";
	rules[STR_IDEternity_01_Shield_Remove] = "The Protective Shield will vanish once you've destroyed the Power Generators.";
	rules[STR_IDEternity_01_Artifact_Turn] = "The Artefact Guardian has begun to activate the Protection Artefact.";
	rules[STR_IDEternity_01_Artifact_Turn_On] = "The Artefact Guardian has activated all Protection Artefacts.";
	rules[STR_IDEternity_01_Artifact_Turn_Off] = "The Artefact Guardian has been vanquished. The Protection Artefact is no longer active.";
	...
	rules[STR_IDEternity_01_Road_Set] = "The entrance to the Library of Knowledge has opened.";
	rules[STR_IDEternity_01_Artifact_Countdown] = "The Protection Artefact unleashes a powerful energy in all regions.";
	rules[STR_IDEternity_01_Cannon] = "As soon as the Guardian falls, the tower's Protective Shield will be deactivated.";
	...
	rules[STR_MSG_CHANGE_PERMANENT_CANT] = "The time limit for this item cannot be changed.";
	rules[STR_MSG_CHANGE_PERMANENT_COMPLETE] = "The time limit of %0 has been removed.";
	rules[STR_IDEternity_01_Cannon_Die] = "The Guardian has fallen and the tower's Protective Shield has been deactivated.";
	...
	rules[STR_MSG_DF6_G1_Boss_Spawn_01] = "The Elyos Fleet Commander appeared.";
	rules[STR_MSG_DF6_G1_Windpath_Off_01] = "The windstream to the defence fleet will disappear in 30 seconds.";
	rules[STR_MSG_LF6_G1_Boss_Spawn_01] = "The Asmodian Fleet Commander has appeared.";
	rules[STR_MSG_LF6_G1_Windpath_Off_01] = "The windstream to the defence fleet will disappear in 30 seconds.";
	...
	rules[STR_MSG_DF6_Evett_G1_Time_End_01] = "The Elyos Fleet's invasion will end in 10 minutes.";
	rules[STR_MSG_DF6_Evett_G1_Time_End_02] = "The Elyos Fleet's invasion will end soon.";
	rules[STR_MSG_DF6_Evett_G1_Time_End_03] = "The Elyos Fleet's invasion is over.";
	rules[STR_MSG_LF6_Evett_G1_Time_End_01] = "The Asmodian Fleet's invasion will end in 10 minutes.";
	rules[STR_MSG_LF6_Evett_G1_Time_End_02] = "The Asmodian Fleet's invasion will end soon.";
	rules[STR_MSG_LF6_Evett_G1_Time_End_03] = "The Asmodian Fleet's invasion is over.";
	rules[STR_MSG_F6_Event_G1_Po_Time_Start_01] = "You can climb the Guard Tower for one minute.";
	rules[STR_MSG_CHARGE_EXP_POINT_NORMAL] = "You received %0%% of the Energy of Growth.";
	...
	rules[STR_MSG_GUILD_CAN_JOIN_LEVEL] = "You have reached the level required for joining a legion. You can find a legion using the legion search.<a href=\"search_guild_dialog\">Open legion search</a>";
	...
	rules[STR_MSG_GUILD_PROCESS_JOIN_MEMBER] = "There is a new legion challenger.";
	rules[STR_MSG_GUILD_PROCESS_END] = "This character is already a member of another legion.";
	...
	rules[STR_MSG_LUNA_WARDROBE_CNOT_OVERLAP] = "A modified appearance can only be removed again by a master redesigner.";
	...
	rules[STR_MSG_LUNA_REWARD_SYSTEM_MSG] = "You met the requirements for the Luna victory and received %0 keys to Munirunerk's Treasure Chest.";
	...
	rules[STR_MSG_LUNA_REWARD_SYSTEM_MSG_SINGLE] = "You met the requirements for the Luna victory and received the key to Munirunerk's Treasure Chest.";
	...
	rules[STR_IDLUNA_DEF_SYSTEM_MSG_01] = "The forward barricade has been destroyed.";
	rules[STR_IDLUNA_DEF_SYSTEM_MSG_02] = "The rear barricade has been destroyed. Atreia is in danger!";
	rules[STR_IDLUNA_DEF_SYSTEM_MSG_03] = "A dark energy begins to manifest.";
	rules[STR_IDLUNA_DEF_SYSTEM_MSG_04] = "The Undead are coming. Protect Atreia!";
	rules[STR_IDLUNA_DEF_PHASE_001] = "You can hear footsteps.";
	rules[STR_IDLUNA_DEF_PHASE_002] = "You can hear loud breathing.";
	rules[STR_IDLUNA_DEF_PHASE_003] = "You can hear a shrill scream.";
	rules[STR_IDLUNA_DEF_PHASE_004] = "You can hear the sound of steel being hammered.";
	rules[STR_IDLUNA_DEF_PHASE_005] = "You can hear a terrible wailing.";
	rules[STR_IDLUNA_DEF_PHASE_006] = "There is an oppressive mood in the air.";
	rules[STR_IDLUNA_DEF_PHASE_007] = "You can hear rustling.";
	rules[STR_IDLUNA_DEF_PHASE_008] = "A dark energy begins to manifest.";
	...
	rules[STR_IDLUNA_DEF_BOXSPAWN_001] = "A Tower Platform appeared. Bright Aether will let use the Guard Tower for 15 seconds.";
	//rules[STR_IDLUNA_DEF_BOXSPAWN_002] = "A Tower Platform appeared. Bright Aether will let use the Guard Tower for 15 seconds.";
	//rules[STR_MSG_NOTICE_DISCONNECT_FILEERROR] = "The game has been terminated due to suspicion of client tampering.";
