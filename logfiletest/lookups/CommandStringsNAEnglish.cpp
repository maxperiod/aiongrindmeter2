...
CommandStringsNAEnglish::CommandStringsNAEnglish(){
	...
	rules[STR_MSG_F2P_GET_EXP_BOOST_VITAL_BONUS] = "You have gained %num1 XP from %0 (Strong Energy of Repose %num2).";
	rules[STR_MSG_F2P_GET_EXP_BOOST_VITAL_MAKEUP_BONUS] = "You have gained %num1 XP from %0 (Strong Energy of Repose %num2, Energy of Salvation %num3).";
	rules[STR_MSG_F2P_GET_EXP2_BOOST_VITAL_BONUS] = "You have gained %num0 XP (Strong Energy of Repose %num1).";
	rules[STR_MSG_F2P_GET_EXP2_BOOST_VITAL_MAKEUP_BONUS] = "You have gained %num0 XP (Strong Energy of Repose %num1, Energy of Salvation %num2).";
	...
	rules[STR_MSG_DELETE_CASH_SOCIALACTION_BY_TIMEOUT] = "Usage time for the %0 emote has expired.";
	...
	rules[STR_MSG_ALARM_REMAIN_PLAYTIME] = "The playing time will expire in %*0. If you wish to continue using the service, please make additional payments on the Billing Page of the Plaync website.";
	...
	rules[STR_MSG_COUNT_REMAIN_PLAYTIME] = "The playing time has expired, and the game will end automatically in %*0.";
	...
	rules[STR_MSG_ACCUSE_UPGRADE_LEVEL] = "You have been placed under Lv. %num0 Probation due to reports regarding your automated hunting. Use the '/probationstatus' command to check your probation status and time remaining until probation is dropped.";
	...
	rules[STR_MSG_TREASUREBOX_DESPAWN_ALL] = "All Balaur treasure chests have disappeared.";
	rules[STR_MSG_TREASUREBOX_DESPAWN_ONE] = "One Balaur treasure chest has disappeared.";
	...
	rules[STR_MSG_DAY_CANNOT_PARTNER_TRADE_LIMIT] = "Your trading partner has reached the daily Trading limit, so the trade has been canceled.";
	rules[STR_MSG_DAY_CANNOT_OWN_TRADE_LIMIT] = "You have reached the daily Trading limit, so the trade cannot be completed.";
	...
	rules[STR_MSG_DAY_CANNOT_SHARE_TRADE_LIMIT] = "One of the Distribution Targets has reached the daily Trading limit, so the trade cannot be completed.";
	...
	rules[STR_MSG_PET_ABANDON_EXPIRE_TIME_COMPLETE] = "Your pet's time is up. %0 has gone.";
	...
	rules[STR_MSG_WEEKLY_CANNOT_SELL_NPC] = "Selling your items for %0 Kinah would exceed your weekly limit limit.";
	...
	rules[STR_MSG_CANT_PLUS_ABSOLUTEEXP_BONUS] = "You have too much XP to use this item.";
	rules[STR_GET_EXP_ABSOLUTEEXP_BONUS] = "You have gained %num1 XP from %0 (Golden Vinna Scent %num2).";
	rules[STR_GET_EXP_VITAL_ABSOLUTEEXP_BONUS] = "You have gained %num1 XP from %0 (Energy of Repose %num2 and Golden Vinna Scent %num3).";
	rules[STR_GET_EXP_MAKEUP_ABSOLUTEEXP_BONUS] = "You have gained %num1 XP from %0 (Energy of Relief %num2 and Golden Vinna Scent %num3).";
	rules[STR_GET_EXP_VITAL_MAKEUP_ABSOLUTEEXP_BONUS] = "You have gained %num1 XP from %0 (Energy of Repose %num2, Energy of Relief %num3, and Golden Vinna Scent %num4).";
	rules[STR_MSG_LDF5_Gab1_End01] = "The Advance Corridor leading to the Panesterra Fortress Battle will be closed in 10 minutes.";
	rules[STR_MSG_LDF5_Gab1_End02] = "The Advance Corridor leading to the Panesterra Fortress Battle will be closed in 5 minutes.";
	...
	rules[STR_GET_EXP_PCBANG_VITAL_ABSOLUTEEXP_BONUS] = "You have gained %num1 XP from %0 (PC Cafe Energy of Repose %num2 and Golden Vinna Scent %num3).";
	rules[STR_GET_EXP_PCBANG_VITAL_MAKEUP_ABSOLUTEEXP_BONUS] = "You have gained %num1 XP from %0 (PC Cafe Energy of Repose %num2, Energy of Relief %num3, and Golden Vinna Scent %num4).";
	rules[STR_GET_EXP2_ABSOLUTEEXP_BONUS] = "You have gained %num0 XP (Golden Vinna Scent %num1).";
	rules[STR_GET_EXP2_VITAL_ABSOLUTEEXP_BONUS] = "You have gained %num0 XP (Energy of Repose %num1 and Golden Vinna Scent %num2).";
	rules[STR_GET_EXP2_MAKEUP_ABSOLUTEEXP_BONUS] = "You have gained %num0 XP (Energy of Relief %num1 and Golden Vinna Scent %num2).";
	rules[STR_GET_EXP2_VITAL_MAKEUP_ABSOLUTEEXP_BONUS] = "You have gained %num0 XP (Energy of Repose %num1, Energy of Relief %num2, and Golden Vinna Scent %num3).";
	rules[STR_GET_EXP2_PCBANG_VITAL_ABSOLUTEEXP_BONUS] = "You have gained %num0 XP (PC Cafe Energy of Repose %num1 and Golden Vinna Scent %num2).";
	rules[STR_GET_EXP2_PCBANG_VITAL_MAKEUP_ABSOLUTEEXP_BONUS] = "You have gained %num0 XP (PC Cafe Energy of Repose %num1, Energy of Relief %num2, and Golden Vinna Scent %num3).";
	...
	rules[STR_MSG_QUEST_COOLTIME_START_LIMITED_DURATION] = "This quest can be re-attempted in %DURATIONDAY0s.";
	...
	rules[STR_MSG_TOPPING_NOTICE_EXPIRE_TIME] = "The %1 effect will be over in %DURATIONTIME0.";
	rules[STR_MSG_TOPPING_WARNING_EXPIRE_TIME] = "The %1 effect will be over in %DURATIONTIME0. Before the buff effect disappears, visit the web shop and buy the associated items to continue enjoying a smooth gaming experience. [%shoplink]";
	rules[STR_MSG_TOPPING_EXPIRED] = "The %0 effect has expired. Visit the web shop and buy the associated items to continue enjoying a smooth gaming experience. [%shoplink]";
	...
	rules[STR_MSG_STIGMA_OPEN_NORMAL_SLOT] = "An additional normal Stigma slot is now available.";
	rules[STR_MSG_STIGMA_OPEN_ENHANCED1_SLOT] = "An additional Greater Stigma slot is now available.";
	rules[STR_MSG_STIGMA_OPEN_ENHANCED2_SLOT] = "An additional Major Stigma slot is now available.";
	...
	rules[STR_VIP_NOTICE_EXPIRE_TIME_MSG] = "The %1 effect will be over in %DURATIONTIME0.";
	rules[STR_VIP_WARNING_EXPIRE_TIME_MSG] = "The %1 effect will be over in %DURATIONTIME0. Before the buff effect disappears, visit the web shop to extend your time! [%shoplink]";
	...
	rules[STR_MSG_GACHA_FEVER_ITEM_REWARD] = "Lucky Shugo took out %0% from the highest-grade box to gift to you.";
	rules[STR_MSG_GACHA_FEVER_ITEM_REWARD_MULTI] = "Lucky Shugo took out %1 %0 from the highest-grade box to gift to you.";
	...
	rules[STR_MSG_ACCUSE_INFO_1_LEVEL_BOT] = "Your Probation is currently at Lv. 1. It does not affect regular play but if the number of reports increase along with level restrictions, you will have a limited XP and item acquisition.";
	rules[STR_MSG_ACCUSE_INFO_2_LEVEL_BOT] = "Your Probation is currently at Lv. 2. You now have severely limited XP, Kinah, AP, gatherables, and extracted items.  If the number of reports increase along with level restrictions, you will receive a larger penalty.";
	rules[STR_MSG_ACCUSE_INFO_3_LEVEL_BOT] = "Your Probation is currently at Lv. 3.  You now have severely limited XP, Kinah, AP, gatherables, extracted items, and can no longer acquire loot. You can no longer join groups or alliances. If the number of reports increases along with level restrictions, you will receive a larger penalty.";
	rules[STR_MSG_ACCUSE_INFO_4_LEVEL_BOT] = "Your Probation is currently at Lv. 4.  You cannot acquire loot, XP, Kinah, AP, gatherables, extracted items, and can no longer join groups or alliances.";
	...
	rules[STR_ENCHANT_ITEM_INVALID_STANCE] = "You cannot enchant items while %0.";
	rules[STR_ENCHANT_ITEM_IT_CAN_NOT_BE_ENCHANTED] = "%0 cannot be enchanted.";
	rules[STR_ENCHANT_ITEM_IT_CAN_NOT_BE_ENCHANTED_MORE_TIME] = "%0 cannot be enchanted any more.";
	rules[STR_ENCHANT_ITEM_IT_CAN_NOT_BE_ENCHANTED_TYPE] = "You cannot use %0 to enchant %1.";
	rules[STR_ENCHANT_ITEM_NEED_IDENTIFY] = "You must identify %0 before enhancing it.";
	rules[STR_ENCHANT_ITEM_NO_TARGET_ITEM] = "Cannot find the item.";
	rules[STR_ENCHANT_ITEM_SUCCEED] = "You have successfully enchanted %0.";
	...
	rules[STR_GOLDVENDOR_CANCEL_MAIL_CONTENT] = "The sale from the Kinah Exchange was canceled, so you are being refunded the Kinah you had registered to sell.";
	rules[STR_GOLDVENDOR_CANCEL_MAIL_FROM] = "Kinah Trade Broker";
	rules[STR_GOLDVENDOR_CANCEL_MAIL_TITLE] = "The Kinah sale has been canceled.";
	rules[STR_GOLDVENDOR_POPUP_BUY_ERROR1_DESC] = "You do not have enough NCoin to buy this item. Please try again after purchasing more NCoin.";
	rules[STR_GOLDVENDOR_POPUP_BUY_ERROR2_DESC] = "The selected item has already been traded or the seller has unregistered it. Please select another item.";
	rules[STR_GOLDVENDOR_POPUP_SELL_ERROR1_DESC] = "You must enter all the required information about the item for sale.";
	rules[STR_GOLDVENDOR_POPUP_SELL_ERROR2_DESC] = "You currently have 10 items registered for sale. You cannot register any more items.";
	...
	rules[STR_GOLDVENDOR_RETURN_MAIL_CONTENT] = "Your Kinah has been returned as the sales period has ended.";
	rules[STR_GOLDVENDOR_RETURN_MAIL_FROM] = "Kinah Trade Broker";
	rules[STR_GOLDVENDOR_RETURN_MAIL_TITLE] = "End of sales period";
	rules[STR_GOLDVENDOR_SELLGOLD_MAIL_CONTENT] = "The [%0 [%gchar:money]] you registered at the Kinah Exchange has been sold for [%1 Cash].\nThe fee for the transaction was [%2 Cash] and you received [%3 Binding Cash].\nThe Binding Cash was sent to your account. ";
	rules[STR_GOLDVENDOR_SELLGOLD_MAIL_FROM] = "Kinah Trade Broker";
	rules[STR_GOLDVENDOR_SELLGOLD_MAIL_TITLE] = "Kinah trade has been completed.";
	rules[STR_GUILD_ALREADY_POSTED_THIS_EMBLEM] = "This emblem is already registered.";
	rules[STR_GUILD_BANISHIED_FROM_GUILD_BY_HIM] = "You have been kicked out of the %0 Legion.";
	rules[STR_GUILD_BANISH_CANT_BANISH_SELF] = "You cannot kick yourself out from a Legion.";
	rules[STR_GUILD_BANISH_CANT_BAN_MEMBER_WHILE_WAR] = "You cannot kick a Legion member out during a war.";
	...
	rules[STR_MSG_ASK_PCINFO_OTHER_RACE] = "You cannot check the information on characters of another race.";
	rules[STR_MSG_ATTACK_RESTRICTION_RIDE] = "You cannot attack while mounted.";
	rules[STR_MSG_ATTEND_REWARD_INVALID_LEVEL] = "You can receive only %1 when you are above level %0.";
	rules[STR_MSG_ATTEND_REWARD_REMOVE_EXCESS] = "You have too many Gifts waiting in your Atreian Passport. Discarded the oldest %0.";
	rules[STR_MSG_AUTH_CONNECTION_LOST] = "You have been disconnected from the server.";
	rules[STR_MSG_Anoha_DeSpawn] = "Berserk Anoha has disappeared.";
	rules[STR_MSG_Anoha_Die] = "Berserk Anoha has been defeated.";
	...
	rules[STR_MSG_BATTLEGROUND_START_SCOREMOD] = "Defeating the top ranked race will earn you more points.";
	rules[STR_MSG_BATTLEGROUND_WAIT_TIME] = "Time for group adjustments has expired. No more changes are possible.";
	rules[STR_MSG_BC_NOT_ENOUGH_PARAMETER] = "Builder ChatLogCommand %0 requires %1 parameters.";
	rules[STR_MSG_BINDSTONE_CANNOT_FOR_INVALID_RIGHT] = "You cannot register as you are not %0.";
	rules[STR_MSG_BLDF5_Fortress_GuardianHead_65_Al_PD] = "The Guardian General Buff has been deactivated.";
	rules[STR_MSG_BLDF5_Fortress_GuardianHead_65_Al_Soff] = "The Guardian General's Turning Tide Shield has been deactivated.";
	rules[STR_MSG_BLDF5_Fortress_GuardianHead_65_Al_Son] = "The Balaur recaptured the bind point, and the Turning Tide Shield was cast on the Guardian General.";
	...
	rules[STR_MSG_BOSSTELEPORTER_CREATED_IDDREDAGION_02] = "Captain's Cabin teleport device has been created at the end of the Atrium.";
	rules[STR_MSG_BOSS_SPAWN_IDAB1_DREADGION] = "Captain Adhati has appeared in the Captain's Cabin.";
	rules[STR_MSG_BOSS_SPAWN_IDDF3_DRAGON] = "ChatLogCommander Bakarma has appeared at Beritra's Oracle.";
	rules[STR_MSG_BOSS_SPAWN_IDDF3_DRAGON_1] = "You must kill Afrane, Saraswati, Lakshmi, and Nimbarka to make ChatLogCommander Bakarma appear.";
	rules[STR_MSG_BOSS_SPAWN_IDDF3_DRAGON_2] = "You must kill 3 more Adjutants to make ChatLogCommander Bakarma appear.";
	rules[STR_MSG_BOSS_SPAWN_IDDF3_DRAGON_3] = "You must kill 2 more Adjutants to make ChatLogCommander Bakarma appear.";
	rules[STR_MSG_BOSS_SPAWN_IDDF3_DRAGON_4] = "You must kill 1 more Adjutant to make ChatLogCommander Bakarma appear.";
	rules[STR_MSG_BOSS_SPAWN_IDDREADGION_02] = "Captain Zanata has appeared in the Captain's Cabin.";
	rules[STR_MSG_BOSS_SPAWN_IDDREADGION_03] = "Captain Anusa has appeared in the Captain's Cabin.";
	rules[STR_MSG_BOSS_SPAWN_IDDREADGION_04] = "Captain Anusa is now in the Captain's Cabin.";
	rules[STR_MSG_BOT_CANNOT_RECEIVE_VITAL_BONUS] = "The Energy of Repose is ineffective in your current Restriction Phase.";
	...
	rules[STR_MSG_GODELITE_TimeAttack_Start] = "The Empyrean Lord's Agent will end the battle in 30 minutes.";
	rules[STR_MSG_GOLDVENDOR_GOLD_ALL_ERROR] = "There's no response from the Kinah Exchange. Please try again.";
	rules[STR_MSG_GOLDVENDOR_GOLD_BUY_MESSAGE] = "NCoin purchase successful.";
	rules[STR_MSG_GOLDVENDOR_GOLD_SELL_CANCLE_MESSAGE] = "NCoin sale has been canceled.";
	rules[STR_MSG_GOLDVENDOR_GOLD_SELL_DONE] = "The Kinah you registered at the Kinah Exchange has been sold. ";
	rules[STR_MSG_GOLDVENDOR_GOLD_SELL_REGIST_MESSAGE] = "You have successfully registered NCoin for Sale.";
	rules[STR_MSG_GOLDVENDOR_GOLD_SELL_RETURN] = "The sales period of the Kinah you registered to sell at the Kinah Exchange has expired, so the sale was canceled.";
	rules[STR_MSG_Gab1_RebirthDoor_ATTACKED] = "The Fortress Soul Anchor Barrier is under attack.";
	rules[STR_MSG_Gab1_RebirthDoor_ATTACKED_01] = "The Northwest Quarter Soul Anchor Barrier is under attack.";
	rules[STR_MSG_Gab1_RebirthDoor_ATTACKED_02] = "The Northeast Quarter Soul Anchor Barrier is under attack.";
	...
	rules[STR_MSG_INSTANCE_MOVE_BIRTHAREA_FRIENDLY_IDARENA] = "%0 failed the training and has been sent to the Ready Room.";
	rules[STR_MSG_INSTANCE_MOVE_BIRTHAREA_ME_IDARENA] = "You failed the training and have been sent to the Ready Room.";
	rules[STR_MSG_INSTANCE_NOTICE_BLANK] = " ";
	rules[STR_MSG_INSTANCE_NOTICE_NEAR_LIMIT_POINT_GAP_LOSE] = "You will lose if %0 gets %num1 more points than you.";
	rules[STR_MSG_INSTANCE_NOTICE_NEAR_LIMIT_POINT_GAP_WIN] = "You will win if you exceed %0 points by %num1.";
	rules[STR_MSG_INSTANCE_NOTICE_NEAR_LIMIT_POINT_MAX_ENEMY] = "You will lose if %0 gains %num1 more points.";
	rules[STR_MSG_INSTANCE_NOTICE_NEAR_LIMIT_POINT_MAX_MINE] = "You need %num0 more points to win.";
	...
	rules[STR_MSG_INSTANCE_START_IDLDF5RE_03] = "You entered the Void Cube.";
	rules[STR_MSG_INSTANCE_START_IDLDF5RE_03_L] = "The Legion battle for the Void Cube has begun!";
	rules[STR_MSG_INSTANCE_START_IDLDF5RE_SOLO] = "Enter the Danuar Mysticarium.";
	rules[STR_MSG_INSTANCE_START_IDLDF5b_TD] = "Welcome to The Eternal Bastion.";
	rules[STR_MSG_INSTANCE_START_IDLF1] = "Infiltration of Dark Poeta now commences.";
	rules[STR_MSG_INSTANCE_START_MESSAGE] = "Join the battle in %WORLDNAME0.";
	rules[STR_MSG_INSTANCE_START_ROUND_IDARENA] = "Round %0 begins!";
	...
	rules[STR_MSG_NO_ALPHA_MAP_IN_THIS_ZONE] = "You cannot see the Transparent Map in this region.";
	rules[STR_MSG_NO_AUTHORITY] = "You do not have the authority to use the Alert Chat.";
	rules[STR_MSG_NO_AUTHORITY_RANKER] = "You do not have the authority to use ChatLogCommand Chat.";
	rules[STR_MSG_NO_RELATIONSHIP_RECENTLY] = "You haven't had any interactions recently.";
	rules[STR_MSG_NO_RIGHT_PACKAGE_VERSION] = "You cannot use it because the version of your package is too low.";
	rules[STR_MSG_NUCLEARTELEPORTER_CREATED_IDAB1_DREADGION] = "A Nuclear Control Room Teleporter has been created at the Emergency Exit.";
	rules[STR_MSG_NoticeFlyingArea] = "You can fly in this area.";
	...
	rules[STR_MSG_QUEST_LIMIT_START_DATE_WEEK] = "You can receive a weekly quest again at %1 a.m. on %0.";
	rules[STR_MSG_QUEST_LIMIT_START_WEEK] = "You can receive the weekly quest again at %1 in the morning on %0.";
	rules[STR_MSG_QUEST_TIMMER_FAILED] = "";
	rules[STR_MSG_QUEST_TIMMER_SUCCEEDED] = "";
	rules[STR_MSG_RAGOS_INFO] = "An object of great power waits in Neith's carcass. Obtain it, then register it in the skill window.";
	rules[STR_MSG_RANKER_CAHT_COOLTIME] = "ChatLogCommand chat is available every 30s. Remaining time: %DURATIONTIME0";
	rules[STR_MSG_READ_TODAY_WORDS] = "Your Note: %0";
	rules[STR_MSG_RECEIVE_MAIL] = "Mail has arrived.";
	rules[STR_MSG_REFUND_MONEY_SYSTEM] = "You received a refund of %num0 Kinah.";
	rules[STR_MSG_REJECTED_DUEL] = "%0 is not currently accepting duel requests.";
	...
	rules[STR_SKILL_PENALTY_TITLE] = "Skill Penalty";
	rules[STR_SKILL_PROC_EFFECT_OCCURRED] = "%0 has been activated.";
	rules[STR_SKILL_PROC_EFFECT_OCCURRED_RESISTED_ATTACK] = "%0 controlled the godstone activation of %1.";
	rules[STR_SKILL_PROC_EFFECT_OCCURRED_RESISTED_DEFEND] = "%0 controlled the godstone activation of %1.";
	rules[STR_SKILL_RESISTED_A_TO_B] = "[%SkillTarget] resisted [%SkillCaster]'s [%SkillName].";
	rules[STR_SKILL_RESISTED_A_TO_ME] = "You resisted [%SkillCaster]'s [%SkillName].";
	rules[STR_SKILL_RESISTED_MAGIC_MY] = "You resisted [%SkillCaster]'s magic.";
	...
	rules[STR_SKILL_SUCC_DPHeal_INTERVAL_TO_B] = "You restored %num0 of [%SkillTarget]'s DP by using [%SkillName].";
	rules[STR_SKILL_SUCC_DPHeal_INTERVAL_TO_ME] = "[%SkillName] restored %num0 of your MP.";
	rules[STR_SKILL_SUCC_DPHeal_Instant_HEAL_A_TO_B] = "[%SkillTarget] recovered %num0 DP because [%SkillCaster] used [%SkillName].";
	rules[STR_SKILL_SUCC_DPHeal_Instant_HEAL_A_TO_ME] = "You recovered %num0 DP because [%SkillCaster] used [%SkillName] on you.";
	rules[STR_SKILL_SUCC_DPHeal_Instant_HEAL_A_TO_SELF] = "[%SkillCaster] recovered %num0 DP by using [%SkillName].";
	rules[STR_SKILL_SUCC_DPHeal_Instant_HEAL_ME_TO_B] = "Your [%SkillName] restored %num0 of [%SkillTarget]'s DP.";
	rules[STR_SKILL_SUCC_DPHeal_Instant_HEAL_ME_TO_SELF] = "You recovered %num0 DP by using [%SkillName].";
	rules[STR_SKILL_SUCC_DPTransfer_A_TO_B] = "[%SkillTarget] transferred %num0 DP because [%SkillCaster] used [%SkillName].";
	rules[STR_SKILL_SUCC_DPTransfer_A_TO_ME] = "You received %num0 DP because [%SkillCaster] used [%SkillName].";
	rules[STR_SKILL_SUCC_DPTransfer_A_TO_SELF] = "[%SkillCaster] transferred %num0 DP by using [%SkillName].";
	rules[STR_SKILL_SUCC_DPTransfer_ME_TO_B] = "[%SkillTarget] is in the DP recovery state because you used [%SkillName].";
	...
	rules[STR_SKILL_SUCC_XPBoost_ME_TO_B] = "You gave [%SkillTarget] an XP bonus by using [%SkillName].";
	rules[STR_SKILL_SUCC_XPBoost_ME_TO_SELF] = "You gave yourself an XP bonus by using [%SkillName].";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_HEAL_A_to_B] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_HEAL_A_to_ME] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_HEAL_ME_to_B] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_SKILL_HEAL_A_to_B] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_SKILL_HEAL_A_to_ME] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_SKILL_HEAL_ME_to_B] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_SKILL_heal_MP_A_to_B] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_SKILL_heal_MP_A_to_ME] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_SKILL_heal_MP_ME_to_B] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_heal_MP_A_to_B] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_heal_MP_A_to_ME] = "";
	rules[STR_SKILL_SUCC_convertheal_PROTECT_heal_MP_ME_to_B] = "";
	rules[STR_SKILL_SUCC_protect_PROTECT_A_to_B] = "You received the %num0 damage inflicted on [%SkillTarget] by [%SkillCaster], because of the protection effect you cast on it.";
	rules[STR_SKILL_SUCC_protect_PROTECT_HEAL_A_to_B] = "The protection effect cast on [%SkillTarget] has diverted %num0 damage from [%SkillCaster] to [%Protector].";
	rules[STR_SKILL_SUCC_protect_PROTECT_HEAL_A_to_ME] = "The protection effect cast on you has diverted %num0 damage from [%SkillCaster] to [%Protector].";
	rules[STR_SKILL_SUCC_protect_PROTECT_HEAL_ME_to_B] = "The protection effect cast on [%SkillTarget] has diverted %num0 damage from to [%Protector].";
	...
	rules[STR_TSHIRT_SLOT_ENCHANT_ITEM_WRONG_PACK] = "Manastone slots cannot be expanded on wrapped items.";
	rules[STR_TSHIRT_SLOT_ENCHANT_ITEM_WRONG_SEAL] = "You cannot expand manastone slots for sealed items.";
	rules[STR_UI_COMBAT_NPC_DISCOVERY] = "";
	rules[STR_UI_COMBAT_NPC_FLEE] = "%0 is running away.";
	rules[STR_UI_COMBAT_NPC_FLEE_ORG] = "%0 is running away.";
	rules[STR_UI_COMBAT_NPC_RETURN] = "%0 gives up the pursuit.";
	rules[STR_UI_COMBAT_NPC_RETURN_NOMOVE] = "%0 gives up the attack.";
