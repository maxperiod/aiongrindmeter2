...
CommandStringsNAEnglish::CommandStringsNAEnglish(){
	...
	rules[STR_SKILL_SUCC_ShapeChange_ME_TO_B] = "You transformed [%SkillTarget] into %0 byusing [%SkillName].";
	...
	rules[STR_MSG_INVADE_DIRECT_PORTAL_OPEN_NOTICE] = "<p>The time and space battle has begun.</p><p>If the Vortex of Dimension Generator is destroyed or</p><p>if you get out of the time and space battlefield,</p><p>you will automatically return to your camp and be excluded from the Alliance.</p><p></p><p>You will also be excluded from the Alliance if you return by using a skill or an item.</p>";
	...
	rules[STR_POPUP_ADDEXP_USE_ITEM_CONFIRM] = "<p><font color=\"00CCCC\">%0%</font>will be used</p><p>to obtain a total of<font color=\"00CCCC\">%num1 points</font>.</p>Do you want to use<p><font color=\"00CCCC\">%0%</font>?</p>";
	...
	rules[STR_POPUP_EXP_EXTRACTION_USE_ITEM_CONFIRM] = "<p><font color=\"00CCCC\">%0</font>--by using this item</p><p>you will lose a total of<font color=\"00CCCC\">%num1</font>EXP.</p><p><font color=\"00CCCC\">%0</font>Do you want to use the item?</p>";
	...
	rules[STR_MSG_EVENT_DIRECT_PORTAL_OPEN_NOTICE] = "<p>You're in the Live Party Concert Hall.</p><p>In the Live Party Concert Hall, some functions such as skills, duels, and vehicles are unavailable.</p><p>Have a great time with IU.</p>";
	...
	rules[STR_MSG_SVS_DIRECT_PORTAL_OPEN_NOTICE] = "<p>You have moved through the Advance Corridor.</p><p>If the Advance Corridor Generator has been destroyed,</p><p>you will be forced to return to the area where you came from.</p>";
	...
	rules[STR_MSG_STIGMA_OPEN_NORMAL_SLOT] = "<p>Your normal stigma slots were expanded.</p><p>Talk to a Stigma Master to equip stigmas and obtain new skills.</p><p>You can equip normal stigmas in normal stigma slots.</p>";
	rules[STR_MSG_STIGMA_OPEN_ENHANCED1_SLOT] = "<p>Your high stigma slots were expanded.</p><p>Talk to a Stigma Master to equip stigmas and obtain new skills.</p><p>You can equip Major stigmas in Major stigma slots.</p>";
	rules[STR_MSG_STIGMA_OPEN_ENHANCED2_SLOT] = "<p>Your highest stigma slots were expanded.</p><p>Talk to a Stigma Master to equip stigmas and obtain new skills.</p><p>You can equip highest grade stigmas in normal/Major/highest grade stigma slots.</p>";
	...
	rules[STR_MSG_EVENT_MSG_TEST6] = "The playing time will expire shortly. To continue using the service, please make additional payments on the Billing Page of the Plaync website.<a href=\"ingame_web_shop_dialog\">Open Zephyr's Shop</a>";
	...
	rules[STR_ACCUSE_UPGRADE_1_LEVEL] = "You have been placed under Lv. 1 Probation due to reports regarding your automated hunting. The Lv. 1 Probation does not hinder your gameplay, but continued reports against you will result in restrictions to your in-game items and XP..<br>You can use the '/Propation' command to check your current Probation Phase.<br>Enter '<font color=\"ff0000\">%0</font>' in the input window after you check the message.";
	rules[STR_ACCUSE_UPGRADE_2_LEVEL] = "You have been placed under Lv. 2 Probation due to reports regarding your automated hunting. The Lv. 2 Probation lowers your XP, Kinah, and AP acquisition rates, and gathering and extraction success rates. Continued reports will lead to increased restrictions.<br>You can use the '/Probation' command to check your current Probation status.<br>Enter '<font color=\"ff0000\">%0</font>' in the input window after you check the message.";
	...
	rules[STR_ACCUSE_UPGRADE_4_LEVEL] = "You have been placed under Lv. 4 Probation due to reports regarding your automated hunting. You can no longer acquire XP, Kinah, AP, gatherables, or extracted items, and can no longer join groups or alliance.<br>You can use the '/Probation' command to check your current Probation status.<br>Enter '<font color=\"ff0000\">%0</font>' in the input window after you have checked the message.";
	rules[STR_ACCUSE_DEGRADE_LEVEL] = "Your restriction phase has been lowered to %num0 as you played fair for a certain period of time. Please continue to play fair in the future.<br>You can use the ‘Restriction' command to check your current Restriction Phase.";
	rules[STR_ACCUSE_DEGRADE_NORMAL_LEVEL] = "You returned to a normal state because you played fair for a certain period of time. Please continue to play fair in the future.<br>You can use the ‘Restriction' command to check your current Restriction Phase.";
	rules[STR_FATIGUE_UPGRADE_1_LEVEL] = "You received Lv.1 Rest Recommendation because you have been playing for too long. While the Lv.1 Rest Recommendation is in effect, your rewards are halved.<br>For your health, please log out and take a rest.<br>You can use the ‘/RestRecommendation' command to check your Rest Recommendation Level.";
	rules[STR_FATIGUE_UPGRADE_2_LEVEL] = "You received Lv.2 Rest Recommendation because you have been playing for too long. While the Lv.2 Rest Recommendation is in effect, you cannot obtain rewards or trade items. Upon death, the character is teleported to a set resurrection point.<br>Please log out and take a break for your health.<br>You can use the ‘/RestRecommendation' command to check your Rest Recommendation Level.";
	...
	rules[STR_CONFIRM_INVADE_DIRECT_PORTAL_DEFENSE_FORCE_OUT] = "<p>You are now out of the Time and Space Defense Zone.</p><p>Unless you return within a certain duration, you will automatically be withdrawn from the time and space defense force.</p>";
	...
	rules[STR_MSG_RVR_DIRECT_PORTAL_OPEN_NOTICE] = "<p>The battle has begun.</p><p>If you get out of the time and space battlefield,</p><p>you will automatically return to your camp and be excluded from the Alliance.</p><p></p><p>You will also be excluded from the Alliance if you return by using a skill or an item.</p>";
	...
	rules[STR_MSG_CPSTONE_OPEN_SLOT] = "<p>You have expanded your Estima slots.</p><p>You can obtain Power of Creation by equipping Estima.</p><p><a href=\"player_info_dialog\" rel=\"dialog_tab\" tab_name=\"tabbtn_highdeva\">Equipping Estima</a></p>";
	...
	rules[STR_MSG_CUSTOMIZING_SELECT_COST] = "<p>Select how you want to pay the fee. (Owned Kinah:%0)</p><p>(%1Luna or Plastic Surgery Ticket)</p>";
	rules[STR_MSG_GENDER_SELECT_COST] = "<p>Select how you want to pay the fee. (Owned Kinah:%0)</p><p>(%1Luna or Gender Switch Ticket)</p>";
	...
	rules[STR_MSG_QUNAMARKET_ERROR_01] = "<p>You cannot access the shop server.(%0)</p><p>Please launch the client again to use the shop.</p>";
	rules[STR_MSG_QUNAMARKET_ERROR_02] = "<p>Shop server cannot be opened.</p><p>Please launch the client again to use the shop.</p>";
	rules[STR_MSG_QUNAMARKET_ERROR_03] = "<p>Connection to the shop server was interrupted.</p><p>Please launch the client again to use the shop.</p>";
