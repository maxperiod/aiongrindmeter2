...
CommandStringsNAEnglish::CommandStringsNAEnglish(){
	...
	rules[STR_ZONE_NAME_IDAb1_Dreadgion] = "Dredgion";
	...
	rules[STR_SKILL_EFFECT_PETRIFICATION_END] = "You cannot register Chain Skills.";
	...
	rules[STR_MSG_BATTLEGROUP_CHAT_NOTI01] = "The Battlefield Alliance chat is now available. Enter '/b' in the chat window to talk to your Battlefield Alliance members.";
	rules[STR_MSG_BATTLEGROUP_CHAT_NOTI02] = "The Battlefield Alliance chat is available even when the official Battlefield Alliance is being prepared.";
	rules[STR_MSG_BATTLEGROUP_CANNOT_USE] = "You must join a Battlefield Alliance to use the Battlefield Alliance chat.";
	...
	rules[STR_MSG_SKILL_CUSTOM_UI_CANT_USE] = "You cannot use skills in the Custom Skill window.";
	...
	rules[STR_MSG_MONSTER_ACHIEVEMENT_COMPLETION2] = "Your book is completed.<a href=\"monster_achievement_dialog\">Open Atreian Bestiary";
	...
	rules[STR_MSG_EQUIPMENT_CHANGE_CANNOT_REGISTER] = "This item cannot be registered as an equipment set.";
